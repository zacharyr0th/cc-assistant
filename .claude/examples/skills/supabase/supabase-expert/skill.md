...
grep -r "related_term_1\|related_term_2\|related_term_3" ./docs/supabase/ -l
```
...
AUTH_DOCS=$(grep -r "authentication\|sign.*in\|auth\..*" ./docs/supabase/guides/auth/ -l)
...
**Search Strategy:**
```bash
grep -r "multi.*tenant\|organization\|team.*access" ./docs/supabase/guides/ -l
grep -r "row.*level.*security.*tenant" ./docs/supabase/guides/database/ --include="*.txt" -A 10
```
...
**Search Strategy:**
```bash
grep -r "custom.*claims\|jwt.*metadata\|user.*metadata" ./docs/supabase/guides/auth/ -l
grep -r "auth.*hooks\|hook.*send" ./docs/supabase/guides/auth/ --include="*.txt" -A 10
```
...
**Search Strategy:**
```bash
grep -r "presence\|broadcast\|realtime.*channel" ./docs/supabase/guides/realtime/ -l
```
...
**Search Strategy:**
```bash
grep -r "vector\|embedding\|pgvector\|similarity" ./docs/supabase/guides/ai/ -l
grep -r "semantic.*search\|vector.*search" ./docs/supabase/guides/ai/ --include="*.txt" -A 10
```
...
**Search Strategy:**
```bash
grep -r "edge.*function\|deno\|background.*job" ./docs/supabase/guides/functions/ -l
```
...
**Search:**
```bash
grep -r "connection.*pool\|supavisor\|serverless" ./docs/supabase/guides/ -l
```
...
alias sb-auth="grep -r '$1' ./docs/supabase/guides/auth/ -l"
alias sb-db="grep -r '$1' ./docs/supabase/guides/database/ -l"
alias sb-storage="grep -r '$1' ./docs/supabase/guides/storage/ -l"
alias sb-realtime="grep -r '$1' ./docs/supabase/guides/realtime/ -l"
alias sb-functions="grep -r '$1' ./docs/supabase/guides/functions/ -l"
alias sb-ai="grep -r '$1' ./docs/supabase/guides/ai/ -l"

# Find API reference
alias sb-api="grep -r '$1' ./docs/supabase/reference/ -l | head -20"
```
