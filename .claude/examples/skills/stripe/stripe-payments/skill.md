...
```bash
# Find payment docs
grep -r "PaymentIntent\|payment\|charge" ./docs/stripe/payments/

# Find authentication docs
grep -r "3D Secure\|SCA\|authentication" ./docs/stripe/payments/

# Find refund docs
grep -r "refund\|cancel" ./docs/stripe/payments/

# List payment files
ls ./docs/stripe/payments/
```
