...
```bash
# Find Terminal docs
grep -r "Terminal\|reader\|in-person" ./docs/stripe/terminal/

# Find Issuing docs
grep -r "Issuing\|card\|authorization" ./docs/stripe/issuing/

# List Terminal files
ls ./docs/stripe/terminal/

# List Issuing files
ls ./docs/stripe/issuing/
```
